...
--select TransactionID into #mytemp from TerminalSales where SaleDate > '2020-01-01 00:00:00' and SaleType in (0,8)
...
while @@rowcount <> 0
  BEGIN
	...
	--IF @diff = 0 GOTO Next_transaction --GOTO Next Transaction
  	...
  	--select @member = MemberNo from terminalsales where TransactionID = @transactionid
